...
namespace CongressoApp.Areas.SysAdmin.Controllers
{
    public class UsersController : Controller
    {
        ...
        public ActionResult Edit(UsersViewModel model)
        {
            ...
            {
                //model.User.UserApprover = UserManager.Users.Where(u => u.Id.Equals(model.User.UserApprover.Id)).First();
                ApplicationUser user = model.User;
                //db.Users.Attach(user.UserApprover);
